...
UstSatir	mov &Delay100ms, R15 ;wait 0.5 seconds
			call #Delay
			mov &Delay100ms, R15
			call #Delay
			mov &Delay100ms, R15
...
AltSatir	mov.b #01h, flag
			mov.w R9, R7
			mov &Delay2ms, R15
			call #Delay
			call #YeniSatir; jump to down screen
			jmp Loop
...
YeniSatir  	clr R5
			...
			mov &Delay50us, R15
			call #Delay
			ret; modified so it returns to correct place
